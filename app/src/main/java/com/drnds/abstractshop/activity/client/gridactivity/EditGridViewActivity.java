package com.drnds.abstractshop.activity.client.gridactivity;
...
import com.drnds.abstractshop.activity.client.NavigationActivity;
...
import static com.drnds.abstractshop.activity.client.LoginActivity.LOGINPREFS_NAME;
import static com.drnds.abstractshop.adapter.client.RecyclergridviewAdapter.GRID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(EditGridViewActivity.this, permission) != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale(EditGridViewActivity.this, permission)) {
                        showError();

                    } else {
                        ActivityCompat.requestPermissions(EditGridViewActivity.this, new String[]{permission}, PERMISSIONS_REQUEST_CODE);
                    }
                } else {
