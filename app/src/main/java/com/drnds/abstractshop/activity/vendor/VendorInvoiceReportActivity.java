package com.drnds.abstractshop.activity.vendor;
...
import com.drnds.abstractshop.adapter.vendor.VendorInvoiceReportAdapter;
...
public class VendorInvoiceReportActivity extends AppCompatActivity {
    private ArrayList<VendorGridItem> vendorgridItemList = new ArrayList<>();
    private RecyclerView recyclerView;
    private VendorInvoiceReportAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vendor_invoice_report);
        recyclerView = (RecyclerView) findViewById(R.id.vendorinvoicerecycle_vencomp);
        toolbar = (Toolbar) findViewById(R.id.vendorinvoicetoolbar_vendorcomp);
        toolbarh = (Toolbar) findViewById(R.id.vendorinvoicetoolbar_hide);
        emptyView = (TextView) findViewById(R.id.vendorinvoiceempty_view);
        emptyViewimg = (ImageView) findViewById(R.id.vendorinvoiceempty_view_image);
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        if(jsonArray.isNull(0)){
                            stopDialog();
                            TastyToast.makeText( VendorInvoiceReportActivity.this,"No  Orders Found",TastyToast.LENGTH_SHORT,TastyToast.ERROR);
                            recyclerView.setVisibility(View.GONE);
                            emptyView.setVisibility(View.VISIBLE);
                            emptyViewimg.setVisibility(View.VISIBLE);
...
//
                            ...
                            mAdapter = new VendorInvoiceReportAdapter(vendorgridItemList);
