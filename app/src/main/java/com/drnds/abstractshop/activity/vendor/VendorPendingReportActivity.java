...
import com.drnds.abstractshop.adapter.vendor.VendorCompletedAdapter;
...
public class VendorPendingReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vendor_pending_report);
        recyclerView = (RecyclerView) findViewById(R.id.recycle_venpen);
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        if(jsonArray.isNull(0)){
                            stopDialog();
                            TastyToast.makeText( VendorPendingReportActivity.this,"No  Orders Found",TastyToast.LENGTH_SHORT,TastyToast.ERROR);
                            recyclerView.setVisibility(View.GONE);
                            emptyView.setVisibility(View.VISIBLE);
                            emptyViewimg.setVisibility(View.VISIBLE);
