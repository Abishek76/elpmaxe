package com.drnds.abstractshop.activity.vendor.orderqueueactivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(EditOrderVendorActivity.this, permission) != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale(EditOrderVendorActivity.this, permission)) {
                        showError();

                    } else {
                        ActivityCompat.requestPermissions(EditOrderVendorActivity.this, new String[]{permission}, PERMISSIONS_REQUEST_CODE);
                    }
                } else {
