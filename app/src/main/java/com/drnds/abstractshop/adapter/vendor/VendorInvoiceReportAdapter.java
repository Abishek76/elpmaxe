package com.drnds.abstractshop.adapter.vendor;
...
import com.drnds.abstractshop.activity.vendor.gridactivity.EditGridViewVendorActivity;
import com.drnds.abstractshop.model.vendor.VendorGridItem;
import com.drnds.abstractshop.util.Logger;

import java.util.ArrayList;

import static com.drnds.abstractshop.util.Config.Order_Filter;

/**
 * Created by ajith on 4/6/2018.
 */

public class VendorInvoiceReportAdapter extends RecyclerView.Adapter<VendorInvoiceReportAdapter.MyViewHolder>implements Filterable {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private VendorInvoiceReportAdapter.ItemClickListener itemClickListener;

        public MyViewHolder(View view) {
            super(view);

            subclient = (TextView) view.findViewById(R.id.invoicevendor_grid_subclient);
            oderno = (TextView) view.findViewById(R.id.invoicevendor_grid_orderno);
            producttype = (TextView) view.findViewById(R.id.invoicevendor_gridview_producttype);
            state = (TextView) view.findViewById(R.id.invoicevendor_gridview_state);
            county = (TextView) view.findViewById(R.id.invoicevendor_gridview_county);
            propertyaddress = (TextView) view.findViewById(R.id.invoicevendor_gridview_address);
            status = (TextView) view.findViewById(R.id.invoicevendor_grid_status);
            barrowername = (TextView) view.findViewById(R.id.invoicevendor_gridview_borrowername);
        ...
        public void setItemClickListener(VendorInvoiceReportAdapter.ItemClickListener ic) {
            this.itemClickListener = ic;
        }
    }

    public VendorInvoiceReportAdapter(ArrayList<VendorGridItem> vendorgridItemList) {
    ...
    @Override
    public VendorInvoiceReportAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.vendor_invoicereportrow, parent, false);

        return new VendorInvoiceReportAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(VendorInvoiceReportAdapter.MyViewHolder holder, final int position) {
...
//        for animation
        holder.setItemClickListener(new VendorInvoiceReportAdapter.ItemClickListener() {
            @Override
