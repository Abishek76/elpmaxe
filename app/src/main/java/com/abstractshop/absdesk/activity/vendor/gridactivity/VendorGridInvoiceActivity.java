...
public class VendorGridInvoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputlayoutcopycost=(TextInputLayout)findViewById(R.id.input_vengridlayout_copycost);
        inputlayoutsearchcost=(TextInputLayout)findViewById(R.id.input_vengridlayout_searchcost);
        inputordercost = (TextView) findViewById(R.id.input_vengridordercost);
...
//        Logger.getInstance().Log("set Order id " + getorderID());
...
//    });
        ...
        inputinvoicedate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(VendorGridInvoiceActivity.this,R.style.datepicker,new DatePickerDialog.OnDateSetListener() {
