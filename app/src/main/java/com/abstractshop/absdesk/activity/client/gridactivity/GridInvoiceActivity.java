package com.abstractshop.absdesk.activity.client.gridactivity;
...
import static com.abstractshop.absdesk.adapter.client.RecyclergridviewAdapter.GRID;
...
public class GridInvoiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputlayoutcopycost=(TextInputLayout)findViewById(R.id.input_gridlayout_copycost);
        inputlayoutsearchcost=(TextInputLayout)findViewById(R.id.input_gridlayout_searchcost);
        inputordercost = (TextView) findViewById(R.id.input_gridordercost);
...
//        });
        ...
        inputinvoicedate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(GridInvoiceActivity.this,R.style.datepicker,new DatePickerDialog.OnDateSetListener() {
