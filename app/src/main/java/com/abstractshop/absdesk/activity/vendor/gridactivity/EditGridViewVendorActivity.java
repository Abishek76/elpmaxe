package com.abstractshop.absdesk.activity.vendor.gridactivity;
...
import com.abstractshop.absdesk.activity.vendor.VendorNavigationActivity;
...
import static com.abstractshop.absdesk.activity.vendor.VendorLoginActivity.VENDORLOGINPREFS_NAME;
import static com.abstractshop.absdesk.adapter.vendor.VendorRecyclegridviewAdapter.VENDORGRID;
...
//        Logger.getInstance().Log("venorder info2025   : " + getInfo());
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(EditGridViewVendorActivity.this, permission) != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale(EditGridViewVendorActivity.this, permission)) {
                        showError();

                    } else {
                        ActivityCompat.requestPermissions(EditGridViewVendorActivity.this, new String[]{permission}, PERMISSIONS_REQUEST_CODE);
                    }
                } else {
